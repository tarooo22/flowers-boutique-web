...
export const journalPosts: JournalPost[] = [
    ...
    content: {
      en: {
        ...
        body: [
          ...
          "Strip any leaves that would sit below the waterline. Submerged foliage breaks down fast, clouds the water and feeds the bacteria that shorten a bouquet's life. Then change the water every two days, rinsing the vase each time.",
          "Finally, placement matters more than people expect. Keep flowers away from direct sun, heat sources and — surprisingly — bowls of fruit, which release ethylene gas that ages blooms prematurely. A cool spot out of the afternoon light will do more than any sachet of flower food.",
        ],
      },
      ka: {
        ...
        body: [
          ...
          "მოაშორე ყველა ფოთოლი, რომელიც წყლის ხაზს ქვემოთ აღმოჩნდება. წყალში ჩაძირული ფოთლები სწრაფად იშლება, წყალს აბინდებს და ბაქტერიებს კვებავს, რომლებიც თაიგულის სიცოცხლეს ამოკლებს. წყალი ორ დღეში ერთხელ გამოცვალე და ვაზაც ყოველ ჯერზე გაავლე.",
          "ბოლოს, ადგილი იმაზე მნიშვნელოვანია, ვიდრე ბევრს ჰგონია. ყვავილები მოარიდე პირდაპირ მზეს, სითბოს წყაროებსა და — მოულოდნელად — ხილის თასებსაც: ხილი ეთილენის აირს გამოყოფს და ყვავილებს ადრე აბერებს. გრილი ადგილი, რომელსაც შუადღის მზე არ ხვდება, ყვავილის საკვების ნებისმიერ პაკეტზე მეტად დაგეხმარება.",
        ],
      },
      ru: {
        ...
        body: [
          ...
          "Удалите все листья, которые окажутся ниже уровня воды. Погружённая листва быстро разлагается, мутит воду и питает бактерии, сокращающие жизнь букета. Меняйте воду каждые два дня и каждый раз ополаскивайте вазу.",
          "Наконец, место важнее, чем кажется. Держите цветы подальше от прямого солнца, источников тепла и — неожиданно — мисок с фруктами: они выделяют этилен, который преждевременно старит бутоны. Прохладное место вне послеобеденного света поможет лучше любого пакетика подкормки.",
        ],
      },
    },
  },
    ...
    content: {
      en: {
        ...
        body: [
          ...
          "To slow them down for an event, keep them cool and in bud. To speed them up, bring them into a warm room and give them plenty of fresh water. Either way, peonies reward you by doubling in size as they open.",
          "Because their season is so brief, we build a rotating set of peony bouquets each year and retire them the moment the last good stems leave the market. If you see one you love, it's worth not waiting.",
        ],
      },
      ka: {
        ...
        body: [
          ...
          "ღონისძიებამდე მათი გახსნა რომ შეანელო, გრილად შეინახე და კოკრის მდგომარეობაში დატოვე. რომ დააჩქარო, თბილ ოთახში შეიტანე და უხვად მიეცი სუფთა წყალი. ორივე შემთხვევაში, გახსნისას პიონი ზომაში თითქმის ორმაგდება.",
          "რადგან მათი სეზონი ასე მოკლეა, ყოველ წელს პიონის თაიგულების ცვლად კოლექციას ვქმნით და ბაზრიდან ბოლო კარგი ღეროების გასვლასთან ერთად ვხსნით. თუ შენს საყვარელს ნახავ, ლოდინი არ ღირს.",
        ],
      },
      ru: {
        ...
        body: [
          ...
          "Чтобы замедлить раскрытие к событию, держите пионы в прохладе и в бутонах. Чтобы ускорить его, перенесите их в тёплую комнату и дайте много свежей воды. В любом случае при раскрытии пионы увеличиваются почти вдвое.",
          "Их сезон так короток, что каждый год мы собираем меняющуюся подборку пионовых букетов и убираем её, как только с рынка уходят последние хорошие стебли. Если увидите любимый букет, ждать не стоит.",
        ],
      },
    },
  },
  {
    id: "j3",
    slug: "choosing-flowers-by-colour",
    date: "2026-06-30",
    readMinutes: 6,
    ...
    content: {
      en: {
        ...
        body: [
          ...
          "Cool blues and lavenders feel calm and a little unexpected, since true blue is rare in flowers. They suit someone with a modern eye, and they pair especially well with white for a crisp, restful arrangement.",
          "Classic reds still say what they have always said. Save them for the moments that call for it, and let the other colours carry the everyday messages — the small, frequent gestures that flowers are really for.",
        ],
      },
      ka: {
        ...
        body: [
          ...
          "ცივი ლურჯი და ლავანდისფერი მშვიდი და ცოტა მოულოდნელია, რადგან ნამდვილ ლურჯს ყვავილებში იშვიათად ნახავ. ისინი თანამედროვე გემოვნების ადამიანებს უხდება და თეთრთან ერთად სუფთა, მშვიდ კომპოზიციას ქმნის.",
          "კლასიკური წითელი ისევ იმას ამბობს, რასაც ყოველთვის ამბობდა. შეინახე ის განსაკუთრებული მომენტებისთვის, ხოლო დანარჩენ ფერებს მიეცი ყოველდღიური გზავნილების ტარების შესაძლებლობა — იმ პატარა, ხშირი ჟესტებისთვის, რისთვისაც ყვავილებია.",
        ],
      },
      ru: {
        ...
        body: [
          ...
          "Холодные синие и лавандовые оттенки ощущаются спокойными и немного неожиданными, ведь настоящий синий редко встречается в цветах. Они подойдут человеку с современным вкусом и особенно хорошо сочетаются с белым в свежей, спокойной композиции.",
          "Классический красный по-прежнему говорит то, что говорил всегда. Оставьте его для особых моментов, а другим цветам доверьте повседневные послания — небольшие, частые жесты, ради которых и дарят цветы.",
        ],
      },
    },
  },
