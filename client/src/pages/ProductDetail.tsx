...
export default function ProductDetail() {
  ...
  return (
    <div className="p2-product-page min-h-screen bg-[#f7f2e9] text-[#181614]">
      <Navbar />
      <main>
        ...
        <section className="fb-page-shell fb-product-layout" aria-labelledby="product-title">
          <div className="fb-product-gallery" aria-label={ka ? "პროდუქტის ფოტოები" : "Product images"}>
          ...
          <div className="fb-product-copy">
            ...
            <button type="button" className="fb-product-add" disabled={!product.isAvailable || selectedVariant?.available === false} onClick={addProduct} aria-describedby="product-price product-availability">{added ? <><Check size={19} /> {ka ? "დაემატა" : "Added"}</> : <><ShoppingBag size={19} /> {ka ? "კალათაში დამატება" : "Add to cart"}</>}</button>
