...
export default function ProductDetail() {
  ...
  return (
    <div className="p2-product-page p3-product-amelie-page min-h-screen bg-[#f7f2e9] text-[#181614]">
      <Navbar />
      <main>
        ...
        <section className="fb-page-shell fb-product-layout p3-product-amelie-layout" aria-labelledby="product-title">
          ...
          <div className="fb-product-copy p3-product-amelie-copy">
            ...
            <div className="p3-product-amelie-purchase-card" data-availability={product.isAvailable ? "available" : "unavailable"}>
